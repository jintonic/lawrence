...
CDPATH=.:$PREFIX
MANPATH=$PREFIX/share/man:$PREFIX/man:$MANPATH
...
export ROOTSYS=$PREFIX/src/root-6.26.02/mybuild
...
# geant4
export G4INSTALL=$PREFIX/share/Geant4-10.5.0
...
export DAWN_BATCH=1
export G4VRMLFILE_VIEWER=orbisnap
